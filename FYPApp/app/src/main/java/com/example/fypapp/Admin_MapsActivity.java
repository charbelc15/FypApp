...
public class Admin_MapsActivity extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMarkerDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    for(DataSnapshot item_snapshot:snapshot.getChildren()) {
                        String databaseLatitudeString = item_snapshot.child("latitude").getValue().toString().substring(1,item_snapshot.child("latitude").getValue().toString().length()-1);
                        String databaseLongitudeString = item_snapshot.child("longitude").getValue().toString().substring(1,item_snapshot.child("longitude").getValue().toString().length()-1);
                        ...
                        //show it on the map after data has changed from DB Side + move camera to marker
                        MarkerOptions markerOptions = new MarkerOptions().position(latLng).title(item_snapshot.getKey());
                        ...
                        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(colours[new Random().nextInt(colours.length)]));
        ...
        getDrivingDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new FetchURL(Admin_MapsActivity.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
                travelFlag="driving";
            }
        });
        ...
        getWalkingDirection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new FetchURL(Admin_MapsActivity.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "walking"), "walking");
                travelFlag="walking";
            }
        });
...
//        this deletes the marker by clicking on it
    ...
    private void Notify(LatLng position) {
        ...
        Intent intent = new Intent(Admin_MapsActivity.this, Admin_MapsActivity.class);
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(Admin_MapsActivity.this,0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
